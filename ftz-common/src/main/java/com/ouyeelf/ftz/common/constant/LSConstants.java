...
public class LSConstants {
	...
	public static final String WARRANTY_FREEZE="101"	;//已冻结(挂牌锁定)
	public static final String WARRANTY_LOSS="102"	;//已挂失
	public static final String WARRANTY_LOCK="103"	;//已成交锁定(交易)
	public static final String WARRANTY_CHANGE="104"	;//已过户
	public static final String WARRANTY_FREE_ZE="106"	;//已冻结
	public static final String WARRANTY_UNLOCK="05"	;//解冻  回到登记状态
	public static final String WARRANTY_UNFREEZE="05"	;//解锁  回到登记状态
	public static final String WARRANTY_DWCYZ="06"	;//待仓库验证
	public static final String WARRANTY_DQSYZ="07"	;//待仓库验证
    ...
    //自贸区仓单类型
    public static final String WARRANTY_TYPE_SHIWU="10";//实物
    public static final String WARRANTY_TYPE_BAOHAN="20";//保函
    public static final String WARRANTY_TYPE_BAOZHENGJIN="30";//保证金
    public static final String WARRANTY_TYPE_TIDAN="40";//提单
    
    public static final String FTZ_MARKET_FLAG="10";//自贸区市场标记
    
	// 比对类型（1：按量按货主 2-实物比对，3-按量不安货主，4-异议）
	public static final String COMPARE_DATA_QUANTITY_OWNER = "1";
	public static final String COMPARE_DATA_ENTITY = "2";
	public static final String COMPARE_DATA_QUANTITY = "3";
	public static final String COMPARE_DATA_OBJECTION = "4";
	
	//仓库实时比对－－数据来源方式　0：实时　1:文件
	public static final String ENTITY_INTEEFACE_SS = "0";//实时
	public static final String ENTITY_INTEEFACE_WJ = "1";//文件
	
	// 仓库是否过户（0-不过户，1-过户）
	public static final String COMPARE_DATA_TRANSFER_NO = "0";
	public static final String COMPARE_DATA_TRANSFER_YES = "1";

	
	// 比对来源 0:仓储 1：清算 2：海关
	public static final String FROM_FLAG_CC = "0";
	public static final String FROM_FLAG_QS = "1";
	public static final String FROM_FLAG_HG = "2";
	
	//短息发送code
	public static final String MSG_COMPARE_YY="160301";//比对异议短信发送异
}
