...
import com.ouyeelf.ftz.rsdb.imp.domain.change.WarrantySearchHisChange;
 ...
 */
public class WarrantySearchHisBeanDao{

	/** The db. */
	private static DB db = MongoUtil.getDB();

	/** The dc. */
	private static DBCollection dc = db.getCollection("warrantySearchHisBean");
	 ...
	 */
	public boolean addResource(WarrantySearchHisBean warrantySearchHisBean) {
		DBObject dbo = WarrantySearchHisChange.change(warrantySearchHisBean);
	 ...
	 * @return true, if successful
	 */
	public boolean addResourceAll(List<WarrantySearchHisBean> warrantySearchHisBean) {
		DBObject[] dbos = new DBObject[warrantySearchHisBean.size()];

		for (int i = 0, size = warrantySearchHisBean.size(); i < size; i++) {
			
			dbos[i] = WarrantySearchHisChange.change(warrantySearchHisBean.get(i));
		}
	 ...
	 * @return true, if successful
	 */
	public boolean removeResourcePhysics(WarrantySearchHisBean warrantySearchHisBean) {
		DBObject dbo = new BasicDBObject();
		dbo.put("warrantyNo", warrantySearchHisBean.getWarrantyNo());
	 ...
	 * @return true, if successful
	 */
	public boolean updateResource(WarrantySearchHisBean warrantySearchHisBean) {
		if (removeResourcePhysics(warrantySearchHisBean)) {
			return addResource(warrantySearchHisBean);
		}
