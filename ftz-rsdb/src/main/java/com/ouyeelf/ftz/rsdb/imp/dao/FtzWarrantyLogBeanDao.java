 ...
 */
public class FtzWarrantyLogBeanDao{

	/** The db. */
	private static DB db = MongoUtil.getDB();

	/** The dc. */
	private static DBCollection dc = db.getCollection("ftzWarrantyLogBean");
	 ...
	 */
	public boolean addResource(FtzWarrantyLogBean ftzWarrantyLogBean) {
		DBObject dbo = FtzWarrantyLogBeanChange.change(ftzWarrantyLogBean);
	 ...
	 * @return true, if successful
	 */
	public boolean removeResourcePhysics(FtzWarrantyLogBean ftzWarrantyLogBean) {
		DBObject dbo = new BasicDBObject();
		dbo.put("id", ftzWarrantyLogBean.getId());
	 ...
	 * @return true, if successful
	 */
	public boolean updateResource(FtzWarrantyLogBean ftzWarrantyLogBean) {
		if (removeResourcePhysics(ftzWarrantyLogBean)) {
			return addResource(ftzWarrantyLogBean);
		}
