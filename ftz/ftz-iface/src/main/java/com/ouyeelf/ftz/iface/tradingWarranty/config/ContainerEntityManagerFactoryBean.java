package com.ouyeelf.ftz.iface.tradingWarranty.config;
...
import com.ouyeelf.ftz.iface.tradingWarranty.util.ClassPathScaner;
/**
...
public class ContainerEntityManagerFactoryBean extends AbstractEntityManagerFactoryBean {
    ...
    protected EntityManagerFactory createNativeEntityManagerFactory() throws PersistenceException {
        Assert.isTrue((persistenceUnitManager != null || persistenceUnitInfo != null), "需要设置" +
        		"或persistenceUnitInfo属性");
